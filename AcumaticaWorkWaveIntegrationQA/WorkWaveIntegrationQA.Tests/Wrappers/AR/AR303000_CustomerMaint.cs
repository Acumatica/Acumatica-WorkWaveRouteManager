...
namespace WorkWaveIntegrationQA.Tests.Wrappers
{
    ...
    public class AR303000_CustomerMaint : Wrapper
    {
        ...
        protected c_baccount_frmprimarycontact0 BAccount_frmPrimaryContact0 { get; } = new c_baccount_frmprimarycontact0("ctl00_phG_tab_t0_frmPrimaryContact0", "BAccount_frmPrimaryContact0");
        ...
        protected c_currentcustomer_referencenbr CurrentCustomer_ReferenceNbr { get; } = new c_currentcustomer_referencenbr("ctl00_phG_tab_t0_ReferenceNbr", "CurrentCustomer_ReferenceNbr");
        protected c_currentcustomer_cstformview6 CurrentCustomer_CstFormView6 { get; } = new c_currentcustomer_cstformview6("ctl00_phG_tab_t3_DefLocation_CstFormView6", "CurrentCustomer_CstFormView6");
        ...
        public class c_baccount_frmprimarycontact0 : Container
        {
            ...
            public c_baccount_frmprimarycontact0(string locator, string name) : 
                    base(locator, name)
            {
                PrimaryContactID = new Selector("ctl00_phG_tab_t0_frmPrimaryContact0_edPrmCntID", "Name", locator, null);
			...
			public Button ViewonMap { get; }
                ...
                public PxButtonCollection()
                {
                    PrimaryContactIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t0_frmPrimaryContact0_edPrmCntID\'] div[class=\'editBtnCo" +
                            "nt\'] > div > div", "PrimaryContactIDEdit", "ctl00_phG_tab_t0_frmPrimaryContact0");
                    PrimaryContactIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    AddressLookup = new Button("ctl00_phG_tab_t0_DefAddress_btnAddressLookup", "Address Lookup", "ctl00_phG_tab_t0_frmPrimaryContact0");
                    ViewonMap = new Button("ctl00_phG_tab_t0_DefAddress_btnViewMainOnMap", "View on Map", "ctl00_phG_tab_t0_frmPrimaryContact0");
                }
            }
        }
        ...
        public class c_currentcustomer_referencenbr : Container
        {
            ...
            public c_currentcustomer_referencenbr(string locator, string name) : 
                    base(locator, name)
            {
                AcctReferenceNbr = new PXTextEdit("ctl00_phG_tab_t0_ReferenceNbr_edExtRefNbr", "Ext Ref Nbr", locator, null);
                AcctReferenceNbrLabel = new Label(AcctReferenceNbr);
                AcctReferenceNbr.DataField = "AcctReferenceNbr";
                LocaleName = new Selector("ctl00_phG_tab_t0_ReferenceNbr_edLocaleName", "Locale", locator, null);
			...
			public Button PrimaryContactIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    AddressLookup = new Button("ctl00_phG_tab_t0_DefAddress_btnAddressLookup", "Address Lookup", "ctl00_phG_tab_t0_ReferenceNbr");
                    ViewonMap = new Button("ctl00_phG_tab_t0_DefAddress_btnViewMainOnMap", "View on Map", "ctl00_phG_tab_t0_ReferenceNbr");
                    PrimaryContactIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t0_frmPrimaryContact0_edPrmCntID\'] div[class=\'editBtnCo" +
                            "nt\'] > div > div", "PrimaryContactIDEdit", "ctl00_phG_tab_t0_ReferenceNbr");
                    PrimaryContactIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
        }
        
        public class c_currentcustomer_cstformview6 : Container
        {
            ...
            public c_currentcustomer_cstformview6(string locator, string name) : 
                    base(locator, name)
            {
                UsrWWStartSec = new DateSelector("ctl00_phG_tab_t3_DefLocation_CstFormView6_CstPXDateTimeEdit8", "Time Window Start", locator, null);
                UsrWWStartSecLabel = new Label(UsrWWStartSec);
                UsrWWStartSec.DataField = "UsrWWStartSec";
                UsrWWEndSec = new DateSelector("ctl00_phG_tab_t3_DefLocation_CstFormView6_CstPXDateTimeEdit7", "Time Window End", locator, null);
			...
			public Button Last { get; }
                ...
                public PxButtonCollection()
                {
                    BtnDefLocationAddressLookup = new Button("ctl00_phG_tab_t3_DefLocation_DefLocationAddress_btnDefLocationAddressLookup", "btnDefLocationAddressLookup", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                    ViewonMap = new Button("ctl00_phG_tab_t3_DefLocation_DefLocationAddress_btnViewDefLocationAddressOnMap", "View on Map", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                    CBranchIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_DefLocation_edCBranchID\'] div[class=\'editBtnCont\'] >" +
                            " div > div", "CBranchIDEdit", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                    ...
                    CPriceClassIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_DefLocation_edCPriceClassID\'] div[class=\'editBtnCont" +
                            "\'] > div > div", "CPriceClassIDEdit", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                    ...
                    CDefProjectIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_DefLocation_edCDefProjectID\'] div[class=\'editBtnCont" +
                            "\'] > div > div", "CDefProjectIDEdit", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                    ...
                    CTaxZoneIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_DefLocation_edCTaxZoneID\'] div[class=\'editBtnCont\'] " +
                            "> div > div", "CTaxZoneIDEdit", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                    ...
                    CCarrierIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_DefLocation_edCarrierID\'] div[class=\'editBtnCont\'] >" +
                            " div > div", "CCarrierIDEdit", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                    ...
                    CShipTermsIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_DefLocation_edShipTermsID\'] div[class=\'editBtnCont\']" +
                            " > div > div", "CShipTermsIDEdit", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                    ...
                    CShipZoneIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_DefLocation_edShipZoneID\'] div[class=\'editBtnCont\'] " +
                            "> div > div", "CShipZoneIDEdit", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                    ...
                    CFOBPointIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_DefLocation_edFOBPointID\'] div[class=\'editBtnCont\'] " +
                            "> div > div", "CFOBPointIDEdit", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                    CFOBPointIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    First = new Button("ctl00_phG_tab_t3_DefLocation_PXGridAccounts_lfFirst0", "First", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                    Prev = new Button("ctl00_phG_tab_t3_DefLocation_PXGridAccounts_lfPrev0", "Prev", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                    Next = new Button("ctl00_phG_tab_t3_DefLocation_PXGridAccounts_lfNext0", "Next", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                    Last = new Button("ctl00_phG_tab_t3_DefLocation_PXGridAccounts_lfLast0", "Last", "ctl00_phG_tab_t3_DefLocation_CstFormView6");
                }
            }
        }
        ...
        public class c_defaddress_defaddress : Container
        {
			...
			public Button PrimaryContactIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    PrimaryContactIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t0_frmPrimaryContact0_edPrmCntID\'] div[class=\'editBtnCo" +
                            "nt\'] > div > div", "PrimaryContactIDEdit", "ctl00_phG_tab_t0_DefAddress");
                    PrimaryContactIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
        }
        ...
        public class c_defcontact_defcontact1 : Container
        {
			...
			public Button PrimaryContactIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    PrimaryContactIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t0_frmPrimaryContact0_edPrmCntID\'] div[class=\'editBtnCo" +
                            "nt\'] > div > div", "PrimaryContactIDEdit", "ctl00_phG_tab_t0_DefContact1");
                    PrimaryContactIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
        }
        ...
        public class c_defcontact_defcontact2 : Container
        {
			...
			public Button PrimaryContactIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    PrimaryContactIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t0_frmPrimaryContact0_edPrmCntID\'] div[class=\'editBtnCo" +
                            "nt\'] > div > div", "PrimaryContactIDEdit", "ctl00_phG_tab_t0_DefContact2");
                    PrimaryContactIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
        }
        ...
        public class c_primarycontactcurrent_frmprimarycontact : Container
        {
			...
			public Button PrimaryContactIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    PrimaryContactIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t0_frmPrimaryContact0_edPrmCntID\'] div[class=\'editBtnCo" +
                            "nt\'] > div > div", "PrimaryContactIDEdit", "ctl00_phG_tab_t0_frmPrimaryContact");
                    PrimaryContactIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
        }
        ...
        public class c_salespersons_pxgrid1 : Grid<c_salespersons_pxgrid1.c_grid_row, c_salespersons_pxgrid1.c_grid_header>
        {
			...
			public PXNumberEdit BAccountID { get; }
                        ...
                        base(grid)
                {
                    ...
                    IsDefault.DataField = "IsDefault";
                    BAccountID = new PXNumberEdit("ctl00_phG_tab_t8_PXGrid1_en", "BAccountID", grid.Locator, "BAccountID");
                    BAccountID.DataField = "BAccountID";
                }
            }
        ...
        public class c_carriers_pxgridaccounts : Grid<c_carriers_pxgridaccounts.c_grid_row, c_carriers_pxgridaccounts.c_grid_header>
        {
			...
			public PXNumberEdit RecordID { get; }
                ...
                public c_grid_row(c_carriers_pxgridaccounts grid) : 
                        base(grid)
                {
                    IsActive = new CheckBox("_ctl00_phG_tab_t3_DefLocation_PXGridAccounts_lv0_chkIsActive", "Active", grid.Locator, "IsActive");
                    IsActive.DataField = "IsActive";
                    CarrierPluginID = new Selector("_ctl00_phG_tab_t3_DefLocation_PXGridAccounts_lv0_edCarrierPluginID", "Carrier", grid.Locator, "CarrierPluginID");
                    CarrierPluginID.DataField = "CarrierPluginID";
                    CarrierAccount = new PXTextEdit("_ctl00_phG_tab_t3_DefLocation_PXGridAccounts_lv0_edCarrierAccount", "Carrier Account", grid.Locator, "CarrierAccount");
                    CarrierAccount.DataField = "CarrierAccount";
                    PostalCode = new PXTextEdit("_ctl00_phG_tab_t3_DefLocation_PXGridAccounts_lv0_PXMaskEdit4", "Postal Code", grid.Locator, "PostalCode");
                    PostalCode.DataField = "PostalCode";
        ...
        public class c_carriers_lv0 : Container
        {
            ...
            public c_carriers_lv0(string locator, string name) : 
                    base(locator, name)
            {
                IsActive = new CheckBox("ctl00_phG_tab_t3_DefLocation_PXGridAccounts_lv0_chkIsActive", "Active", locator, null);
                IsActiveLabel = new Label(IsActive);
                IsActive.DataField = "IsActive";
                CarrierAccount = new PXTextEdit("ctl00_phG_tab_t3_DefLocation_PXGridAccounts_lv0_edCarrierAccount", "Carrier Account", locator, null);
                CarrierAccountLabel = new Label(CarrierAccount);
                CarrierAccount.DataField = "CarrierAccount";
                PostalCode = new PXTextEdit("ctl00_phG_tab_t3_DefLocation_PXGridAccounts_lv0_PXMaskEdit4", "Postal Code", locator, null);
                PostalCodeLabel = new Label(PostalCode);
                PostalCode.DataField = "PostalCode";
                CarrierPluginID = new Selector("ctl00_phG_tab_t3_DefLocation_PXGridAccounts_lv0_edCarrierPluginID", "Carrier", locator, null);
        ...
        public class c_notificationsources_gridns : Grid<c_notificationsources_gridns.c_grid_row, c_notificationsources_gridns.c_grid_header>
        {
			...
			public PXNumberEdit SourceID { get; }
                        ...
                        base(grid)
                {
                    ...
                    NotificationID = new Selector("_ctl00_phG_tab_t13_sp1_gridNS_lv0_edNotificationID", "Email Template", grid.Locator, "NotificationID");
        ...
        public class c_notificationsources_lv0 : Container
        {
                    ...
                    base(locator, name)
            {
                ...
                ReportID.DataField = "ReportID";
                NotificationID = new Selector("ctl00_phG_tab_t13_sp1_gridNS_lv0_edNotificationID", "Email Template", locator, null);
