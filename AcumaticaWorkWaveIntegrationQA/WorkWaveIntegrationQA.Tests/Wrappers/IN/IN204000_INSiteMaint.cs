...
namespace WorkWaveIntegrationQA.Tests.Wrappers
{
    ...
    public class IN204000_INSiteMaint : Wrapper
    {
        ...
        protected c_siteaccounts_formcarrierfacility Siteaccounts_formcarrierfacility { get; } = new c_siteaccounts_formcarrierfacility("ctl00_phG_tab_t4_addrForm_formCarrierFacility", "siteaccounts_formCarrierFacility");
        ...
        public class PxToolBar : PxControlCollection
        {
            ...
            public PxToolBar(string locator)
            {
                ...
                Delete.ConfirmAction = () => Alert.AlertToException("The current Warehouse record will be deleted.");
                ...
                INLocationLabels = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_INLocationLabels,#ctl00_phDS_ds_ToolBar_INLocationLabe" +
                        "ls_item", "Location Labels", locator, MenuOpener);
        ...
        public class c_siteaccounts_formcarrierfacility : Container
        {
            ...
            public c_siteaccounts_formcarrierfacility(string locator, string name) :
                    base(locator, name)
            {
                CarrierFacility = new PXTextEdit("ctl00_phG_tab_t4_addrForm_formCarrierFacility_edCarrierFacility", "Carrier Facility", locator, null);
            ...
            public class PxButtonCollection : PxControlCollection
            {
                ...
                public PxButtonCollection()
                {
                    AddressLookup = new Button("ctl00_phG_tab_t4_addrForm_btnAddressLookup", "Address Lookup", "ctl00_phG_tab_t4_addrForm_formCarrierFacility");
                    ViewonMap = new Button("ctl00_phG_tab_t4_addrForm_btnViewMainOnMap", "View on Map", "ctl00_phG_tab_t4_addrForm_formCarrierFacility");
                    CountryIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t4_addrForm_edCountryID\'] div[class=\'editBtnCont\'] > di" +
                            "v > div", "CountryIDEdit", "ctl00_phG_tab_t4_addrForm_formCarrierFacility");
                    CountryIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    StateEdit = new Button("css=div[id=\'ctl00_phG_tab_t4_addrForm_edState\'] div[class=\'editBtnCont\'] > div > " +
                            "div", "StateEdit", "ctl00_phG_tab_t4_addrForm_formCarrierFacility");
                    StateEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
        }
        ...
        public class c_location_grid : Grid<c_location_grid.c_grid_row, c_location_grid.c_grid_header>
        {
            ...
            public class c_grid_row : GridRow
            {
                ...
                public CheckBox ProductionValid { get; }
                        ...
                        base(grid)
                {
                    ...
                    Active.DataField = "Active";
                    IsSorting = new CheckBox("ctl00_phG_tab_t0_grid_ef", "Sort Location", grid.Locator, "IsSorting");
                    ...
                    ProductionValid = new CheckBox("ctl00_phG_tab_t0_grid", "Production Allowed", grid.Locator, "ProductionValid");
                    ProductionValid.DataField = "ProductionValid";
            ...
            public class c_grid_header : GridHeader
            {
                ...
                public CheckBoxColumnFilter ProductionValid { get; }
                        ...
                        base(grid)
                {
                    ...
                    ProductionValid = new CheckBoxColumnFilter(grid.Row.ProductionValid);
        ...
        public class c_location_lv0 : Container
        {
            ...
            public class PxButtonCollection : PxControlCollection
            {
                ...
                public PxButtonCollection()
                {
                    ...
                    PrimaryItemIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
        ...
        public class c_carts_gridcarts : Grid<c_carts_gridcarts.c_grid_row, c_carts_gridcarts.c_grid_header>
        {
            ...
            public class c_grid_row : GridRow
            {
                        ...
                        base(grid)
                {
                    ...
                    Active = new CheckBox("ctl00_phG_tab_t1_gridCarts_ef", "Active", grid.Locator, "Active");
                    Active.DataField = "Active";
        ...
        public class c_totes_gridtotes : Grid<c_totes_gridtotes.c_grid_row, c_totes_gridtotes.c_grid_header>
        {
            ...
            public class c_grid_row : GridRow
            {
                        ...
                        base(grid)
                {
                    ...
                    Active = new CheckBox("ctl00_phG_tab_t2_gridTotes_ef", "Active", grid.Locator, "Active");
                    Active.DataField = "Active";
        ...
        public class c_totesincart_gridtotesincart : Grid<c_totesincart_gridtotesincart.c_grid_row, c_totesincart_gridtotesincart.c_grid_header>
        {
            ...
            public class c_grid_row : GridRow
            {
                        ...
                        base(grid)
                {
                    ...
                    Descr.DataField = "Descr";
                    Active = new CheckBox("ctl00_phG_ViewTotesInCartDialog_gridTotesInCart_ef", "Active", grid.Locator, "Active");
                    Active.DataField = "Active";
        ...
        public class c_contact_colform : Container
        {
            ...
            public c_contact_colform(string locator, string name) :
                    base(locator, name)
            {
                FullName = new PXTextEdit("ctl00_phG_tab_t4_colForm_edFullName", "Account Name", locator, null);
