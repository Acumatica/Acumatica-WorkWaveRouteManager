    ...
    public class SO301000_SOOrderEntry : Wrapper
    {
        ...
        public class c_currentdocument_formdeliverysettings : Container
        {
                    ...
                    base(locator, name)
            {
                ...
                UsrWWStartSec = new DateSelector("ctl00_phG_tab_t5_formDeliverySettings_CstPXDateTimeEdit4", "Time Window Start", locator, null);
                UsrWWStartSecLabel = new Label(UsrWWStartSec);
                UsrWWStartSec.DataField = "UsrWWStartSec";
                UsrWWEndSec = new DateSelector("ctl00_phG_tab_t5_formDeliverySettings_CstPXDateTimeEdit3", "Time Window End", locator, null);
        ...
        public class c_processingresults : Container
        {
            ...
            public class PxButtonCollection : PxControlCollection
            {
                ...
                public PxButtonCollection()
                {
                    Ok = new Button("ctl00_phDS_ds_pnlQuickInfo_btnOk", "OK", "ctl00$phDS$ds$pnlQuickInfo");
                }
            }
        }
