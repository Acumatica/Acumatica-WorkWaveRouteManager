...
namespace WorkWaveIntegrationQA.Tests.Wrappers
{
    ...
    public class SO302000_SOShipmentEntry : Wrapper
    {
        ...
        protected c_wworders_cstworkwaveorders WWOrders_cstWorkWaveOrders { get; } = new c_wworders_cstworkwaveorders("ctl00_phG_tab_t4_cstWorkWaveOrders", "WWOrders_cstWorkWaveOrders");
        protected c_wworders_lv0 WWOrders_lv0 { get; } = new c_wworders_lv0("ctl00_phG_tab_t4_cstWorkWaveOrders_lv0", "WWOrders_lv0");
        ...
        public virtual void GetDeliveryStatus()
        {
            ToolBar.GetDeliveryStatus.Click();
        }

        public virtual void GetDeliveryStatus(bool status, string message = null)
        {
            ToolBar.GetDeliveryStatus.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.GetDeliveryStatus.Click();
        }

        public virtual void CreateWokWaveOrder()
        {
            ToolBar.CreateWokWaveOrder.Click();
        }

        public virtual void CreateWokWaveOrder(bool status, string message = null)
        {
            ToolBar.CreateWokWaveOrder.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.CreateWokWaveOrder.Click();
        }

        public virtual void DeleteShipment()
        {
            ToolBar.DeleteShipment.Click();
        }

        public virtual void CorrectWWShipment()
        {
            ToolBar.CorrectWWShipment.Click();
        }

        public virtual void CorrectWWShipment(bool status, string message = null)
        {
            ToolBar.CorrectWWShipment.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.CorrectWWShipment.Click();
        }

        public virtual void DeleteWWOrder()
        {
            ToolBar.DeleteWWOrder.Click();
        }
        ...
        public virtual void OrderCreatedSuccess()
        {
            ToolBar.OrderCreatedSuccess.Click();
        }

        public virtual void OrderCreatedFailure()
        {
            ToolBar.OrderCreatedFailure.Click();
        }

        public virtual void OrderRouteAssigned()
        {
            ToolBar.OrderRouteAssigned.Click();
        }

        public virtual void OrderRouteDeleted()
        {
            ToolBar.OrderRouteDeleted.Click();
        }

        public virtual void OrderRouteUnassigned()
        {
            ToolBar.OrderRouteUnassigned.Click();
        }

        public virtual void OrderRouteDelivered()
        {
            ToolBar.OrderRouteDelivered.Click();
        }
        ...
        public class PxToolBar : PxControlCollection
        {
            ...
            public ToolBarButton GetDeliveryStatus { get; }
            public ToolBarButton CreateWokWaveOrder { get; }
            public ToolBarButton DeleteShipment { get; }
            public ToolBarButton CorrectWWShipment { get; }
            public ToolBarButton DeleteWWOrder { get; }
            public ToolBarButton CancelOrder { get; }
            public ToolBarButton OrderCreatedSuccess { get; }
            public ToolBarButton OrderCreatedFailure { get; }
            public ToolBarButton OrderRouteAssigned { get; }
            public ToolBarButton OrderRouteDeleted { get; }
            public ToolBarButton OrderRouteUnassigned { get; }
            public ToolBarButton OrderRouteDelivered { get; }
            ...
            public PxToolBar(string locator)
            {
                ...
                GetDeliveryStatus = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_GetDeliveryStatus,#ctl00_phDS_ds_ToolBar_GetDeliverySt" +
                        "atus_item", "Get Delivery Status", locator, MenuOpener);
                GetDeliveryStatus.WaitAction = Wait.WaitForLongOperationToComplete;
                CreateWokWaveOrder = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_CreateWokWaveOrder,#ctl00_phDS_ds_ToolBar_CreateWokWav" +
                        "eOrder_item", "Create WorkWave Order", locator, MenuOpener);
                CreateWokWaveOrder.WaitAction = Wait.WaitForLongOperationToComplete;
                DeleteShipment = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_DeleteShipment,#ctl00_phDS_ds_ToolBar_DeleteShipment_i" +
                        "tem", "Delete Shipment", locator, MenuOpener);
                CorrectWWShipment = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_CorrectWWShipment,#ctl00_phDS_ds_ToolBar_CorrectWWShip" +
                        "ment_item", "Correct Shipment", locator, MenuOpener);
                CorrectWWShipment.WaitAction = Wait.WaitForLongOperationToComplete;
                DeleteWWOrder = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_DeleteWWOrder,#ctl00_phDS_ds_ToolBar_DeleteWWOrder_ite" +
                        "m", "Delete WorkWave Order", locator, MenuOpener);
                ...
                OrderCreatedSuccess = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_OrderCreatedSuccess,#ctl00_phDS_ds_ToolBar_OrderCreate" +
                        "dSuccess_item", "Order Created Success", locator, MenuOpener);
                OrderCreatedFailure = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_OrderCreatedFailure,#ctl00_phDS_ds_ToolBar_OrderCreate" +
                        "dFailure_item", "Order Created Failure", locator, MenuOpener);
                OrderRouteAssigned = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_OrderRouteAssigned,#ctl00_phDS_ds_ToolBar_OrderRouteAs" +
                        "signed_item", "Order Route Assigned", locator, MenuOpener);
                OrderRouteDeleted = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_OrderRouteDeleted,#ctl00_phDS_ds_ToolBar_OrderRouteDel" +
                        "eted_item", "Order Route Deleted", locator, MenuOpener);
                OrderRouteUnassigned = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_OrderRouteUnassigned,#ctl00_phDS_ds_ToolBar_OrderRoute" +
                        "Unassigned_item", "Order Route Unassigned", locator, MenuOpener);
                OrderRouteDelivered = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_OrderRouteDelivered,#ctl00_phDS_ds_ToolBar_OrderRouteD" +
                        "elivered_item", "Order Route Delivered", locator, MenuOpener);
        ...
        public class c_currentdocument_formf : Container
        {
                    ...
                    base(locator, name)
            {
                ...
                UsrWWStartSec = new DateSelector("ctl00_phG_tab_t2_formF_CstPXDateTimeEdit3", "Time Window Start", locator, null);
                UsrWWStartSecLabel = new Label(UsrWWStartSec);
                UsrWWStartSec.DataField = "UsrWWStartSec";
                UsrWWEndSec = new DateSelector("ctl00_phG_tab_t2_formF_CstPXDateTimeEdit2", "Time Window End", locator, null);
        ...
        public class c_wworders_cstworkwaveorders : Grid<c_wworders_cstworkwaveorders.c_grid_row, c_wworders_cstworkwaveorders.c_grid_header>
        {
            ...
            public c_wworders_cstworkwaveorders(string locator, string name) :
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t4_cstWorkWaveOrders");
                DataMemberName = "WWOrders";
                FilterForm = new c_grid_filter("ctl00_phG_tab_t4_cstWorkWaveOrders_fe_gf", "FilterForm");
                FilesUploadDialog = new SmartPanel_AttachFile(locator);
                NotePanel = new Note(locator);
            }
            ...
            public class PxToolBar : PxControlCollection
            {
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_tab_t4_cstWorkWaveOrders_at_tlb div[data-cmd=\'Refresh\']", "Refresh", locator, null);
                    New = new ToolBarButtonGrid("css=#ctl00_phG_tab_t4_cstWorkWaveOrders_at_tlb div[data-cmd=\'AddNew\']", "Add Row", locator, null);
                    Delete = new ToolBarButtonGrid("css=#ctl00_phG_tab_t4_cstWorkWaveOrders_at_tlb div[data-cmd=\'Delete\']", "Delete Row", locator, null);
                    Delete.ConfirmAction = () => Alert.AlertToException("The current {0} record will be deleted.");
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_tab_t4_cstWorkWaveOrders_at_tlb div[data-cmd=\'AdjustColumns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_tab_t4_cstWorkWaveOrders_at_tlb div[data-cmd=\'ExportExcel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_tab_t4_cstWorkWaveOrders_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_tab_t4_cstWorkWaveOrders_ab_tlb div[data-cmd=\'PageFirst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_tab_t4_cstWorkWaveOrders_ab_tlb div[data-cmd=\'PagePrev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_tab_t4_cstWorkWaveOrders_ab_tlb div[data-cmd=\'PageNext\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_tab_t4_cstWorkWaveOrders_ab_tlb div[data-cmd=\'PageLast\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_tab_t4_cstWorkWaveOrders_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
            ...
            public class c_grid_row : GridRow
            {
                ...
                public NoteColumnButton Notes { get; }
                public CheckBox Selected { get; }
                public PXTextEdit WWOrderName { get; }
                public DropDown WWDeliveryStatus { get; }
                public DateSelector WWDeliveryDateTime_Date { get; }
                public DateSelector WWDeliveryDateTime_Time { get; }
                public PXTextEdit WWGPS { get; }
                public PXNumberEdit WWErrorCode { get; }
                public PXTextEdit WWErrorMessage { get; }
                public PXTextEdit WWTrackingURL { get; }
                public PXTextEdit WWOrderID { get; }
                public PXTextEdit WWRequestID { get; }
                public PXNumberEdit WWLineNbr { get; }
                public PXTextEdit WWEntityID { get; }

                public c_grid_row(c_wworders_cstworkwaveorders grid) :
                        base(grid)
                {
                    Files = new FileColumnButton(null, "Files", grid.Locator, "Files");
                    Notes = new NoteColumnButton(null, "Notes", grid.Locator, "Notes");
                    Selected = new CheckBox("ctl00_phG_tab_t4_cstWorkWaveOrders_ef", "Selected", grid.Locator, "Selected");
                    Selected.DataField = "Selected";
                    WWOrderName = new PXTextEdit("ctl00_phG_tab_t4_cstWorkWaveOrders_ei", "Order Name", grid.Locator, "WWOrderName");
                    WWOrderName.DataField = "WWOrderName";
                    WWDeliveryStatus = new DropDown("_ctl00_phG_tab_t4_cstWorkWaveOrders_lv0_ec", "Delivery Status", grid.Locator, "WWDeliveryStatus");
                    WWDeliveryStatus.DataField = "WWDeliveryStatus";
                    WWDeliveryStatus.Items.Add("O", "Not Created");
                    WWDeliveryStatus.Items.Add("P", "Pending");
                    WWDeliveryStatus.Items.Add("C", "TBS");
                    WWDeliveryStatus.Items.Add("A", "Route Assigned");
                    WWDeliveryStatus.Items.Add("I", "Delivered with Issue");
                    WWDeliveryStatus.Items.Add("D", "Delivered");
                    WWDeliveryStatus.Items.Add("E", "Error");
                    WWDeliveryDateTime_Date = new DateSelector("_ctl00_phG_tab_t4_cstWorkWaveOrders_lv0_ed5", "Delivery DateTime (Date)", grid.Locator, "WWDeliveryDateTime_Date");
                    WWDeliveryDateTime_Date.DataField = "WWDeliveryDateTime_Date";
                    WWDeliveryDateTime_Time = new DateSelector("_ctl00_phG_tab_t4_cstWorkWaveOrders_lv0_ed6", "Delivery DateTime (Time)", grid.Locator, "WWDeliveryDateTime_Time");
                    WWDeliveryDateTime_Time.DataField = "WWDeliveryDateTime_Time";
                    WWGPS = new PXTextEdit("ctl00_phG_tab_t4_cstWorkWaveOrders_ei", "GPS", grid.Locator, "WWGPS");
                    WWGPS.DataField = "WWGPS";
                    WWErrorCode = new PXNumberEdit("ctl00_phG_tab_t4_cstWorkWaveOrders_en", "Error Code", grid.Locator, "WWErrorCode");
                    WWErrorCode.DataField = "WWErrorCode";
                    WWErrorMessage = new PXTextEdit("ctl00_phG_tab_t4_cstWorkWaveOrders_ei", "Error Message", grid.Locator, "WWErrorMessage");
                    WWErrorMessage.DataField = "WWErrorMessage";
                    WWTrackingURL = new PXTextEdit("ctl00_phG_tab_t4_cstWorkWaveOrders_ei", "Tracking URL", grid.Locator, "WWTrackingURL");
                    WWTrackingURL.DataField = "WWTrackingURL";
                    WWOrderID = new PXTextEdit("ctl00_phG_tab_t4_cstWorkWaveOrders_ei", "Order ID", grid.Locator, "WWOrderID");
                    WWOrderID.DataField = "WWOrderID";
                    WWRequestID = new PXTextEdit("ctl00_phG_tab_t4_cstWorkWaveOrders_ei", "Request ID", grid.Locator, "WWRequestID");
                    WWRequestID.DataField = "WWRequestID";
                    WWLineNbr = new PXNumberEdit("ctl00_phG_tab_t4_cstWorkWaveOrders_en", "WWLineNbr", grid.Locator, "WWLineNbr");
                    WWLineNbr.DataField = "WWLineNbr";
                    WWEntityID = new PXTextEdit("ctl00_phG_tab_t4_cstWorkWaveOrders_ei", "Entity ID", grid.Locator, "WWEntityID");
                    WWEntityID.DataField = "WWEntityID";
                }
            }
            ...
            public class c_grid_header : GridHeader
            {
                ...
                public GridColumnHeader Notes { get; }
                public CheckBoxColumnFilter Selected { get; }
                public PXTextEditColumnFilter WWOrderName { get; }
                public DropDownColumnFilter WWDeliveryStatus { get; }
                public DateSelectorColumnFilter WWDeliveryDateTime_Date { get; }
                public DateSelectorColumnFilter WWDeliveryDateTime_Time { get; }
                public PXTextEditColumnFilter WWGPS { get; }
                public PXNumberEditColumnFilter WWErrorCode { get; }
                public PXTextEditColumnFilter WWErrorMessage { get; }
                public PXTextEditColumnFilter WWTrackingURL { get; }
                public PXTextEditColumnFilter WWOrderID { get; }
                public PXTextEditColumnFilter WWRequestID { get; }
                public PXNumberEditColumnFilter WWLineNbr { get; }
                public PXTextEditColumnFilter WWEntityID { get; }

                public c_grid_header(c_wworders_cstworkwaveorders grid) :
                        base(grid)
                {
                    Files = new GridColumnHeader(grid.Row.Files);
                    Notes = new GridColumnHeader(grid.Row.Notes);
                    Selected = new CheckBoxColumnFilter(grid.Row.Selected);
                    WWOrderName = new PXTextEditColumnFilter(grid.Row.WWOrderName);
                    WWDeliveryStatus = new DropDownColumnFilter(grid.Row.WWDeliveryStatus);
                    WWDeliveryDateTime_Date = new DateSelectorColumnFilter(grid.Row.WWDeliveryDateTime_Date);
                    WWDeliveryDateTime_Time = new DateSelectorColumnFilter(grid.Row.WWDeliveryDateTime_Time);
                    WWGPS = new PXTextEditColumnFilter(grid.Row.WWGPS);
                    WWErrorCode = new PXNumberEditColumnFilter(grid.Row.WWErrorCode);
                    WWErrorMessage = new PXTextEditColumnFilter(grid.Row.WWErrorMessage);
                    WWTrackingURL = new PXTextEditColumnFilter(grid.Row.WWTrackingURL);
                    WWOrderID = new PXTextEditColumnFilter(grid.Row.WWOrderID);
                    WWRequestID = new PXTextEditColumnFilter(grid.Row.WWRequestID);
                    WWLineNbr = new PXNumberEditColumnFilter(grid.Row.WWLineNbr);
                    WWEntityID = new PXTextEditColumnFilter(grid.Row.WWEntityID);
                }
            }
        }

        public class c_wworders_lv0 : Container
        {
            ...
            public c_wworders_lv0(string locator, string name) :
                    base(locator, name)
            {
                Ed = new DateSelector("ctl00_phG_tab_t4_cstWorkWaveOrders_lv0_ed", "Ed", locator, null);
                EdLabel = new Label(Ed);
                Ec = new DropDown("ctl00_phG_tab_t4_cstWorkWaveOrders_lv0_ec", "Ec", locator, null);
                DataMemberName = "WWOrders";
            }
        }
