...
namespace WorkWaveIntegrationQA.Tests.Wrappers
{
    ...
    public class SO611061 : Report
    {
        ...
        {
            ScreenId = "SO611061";
            ScreenUrl = "/Frames/ReportLauncher.aspx?ID=SO611061.rpx";
        ...
        public class c__pform : Container
        {
            ...
            public DateSelector EdStartDate { get; }
            public Label EdStartDateLabel { get; }
            public DateSelector EdEndDate { get; }
            public Label EdEndDateLabel { get; }
            public Selector EdShipmentNbr { get; }
            public Label EdShipmentNbrLabel { get; }
            public Selector EdCustomerID { get; }
            public Label EdCustomerIDLabel { get; }
            public Selector EdWarehouse { get; }
            public Label EdWarehouseLabel { get; }
            public Selector EdInventoryID { get; }
            public Label EdInventoryIDLabel { get; }
            public CheckBox EdDriverNotes { get; }
            public CheckBox EdGPS { get; }
            public CheckBox EdPackages { get; }
            public CheckBox EdSignature { get; }
            public CheckBox EdPicture { get; }

            public c__pform(string locator, string name) :
                    base(locator, name)
            {
                EdStartDate = new DateSelector("viewer_par_tab_t0_edStartDate", "Start Date", locator, null);
                EdStartDateLabel = new Label(EdStartDate);
                EdEndDate = new DateSelector("viewer_par_tab_t0_edEndDate", "End Date", locator, null);
                EdEndDateLabel = new Label(EdEndDate);
                EdShipmentNbr = new Selector("viewer_par_tab_t0_edShipmentNbr", "Shipment Nbr", locator, null);
                EdShipmentNbrLabel = new Label(EdShipmentNbr);
                EdCustomerID = new Selector("viewer_par_tab_t0_edCustomerID", "Customer ID", locator, null);
                EdCustomerIDLabel = new Label(EdCustomerID);
                EdWarehouse = new Selector("viewer_par_tab_t0_edWarehouse", "Warehouse", locator, null);
                EdWarehouseLabel = new Label(EdWarehouse);
                EdInventoryID = new Selector("viewer_par_tab_t0_edInventoryID", "Inventory ID", locator, null);
                EdInventoryIDLabel = new Label(EdInventoryID);
                EdDriverNotes = new CheckBox("viewer_par_tab_t0_edDriverNotes", "Driver Notes", locator, null);
                EdGPS = new CheckBox("viewer_par_tab_t0_edGPS", "GPS", locator, null);
                EdPackages = new CheckBox("viewer_par_tab_t0_edPackages", "Packages", locator, null);
                EdSignature = new CheckBox("viewer_par_tab_t0_edSignature", "Signature", locator, null);
                EdPicture = new CheckBox("viewer_par_tab_t0_edPicture", "Picture", locator, null);
                DataMemberName = null;
            }
        }
        ...
        public class c__grids : Grid<c__grids.c_grid_row, c__grids.c_grid_header>
        {
            ...
            public class c_grid_row : GridRow
            {
                        ...
                        base(grid)
                {
                    ...
                    DataField.Items.Add("BAccount.AcctCD", "Business Account.Account ID");
                    DataField.Items.Add("BAccount.AcctName", "Business Account.Account Name");
                    DataField.Items.Add("Note.NoteText", "Note.NoteText");
                    DataField.Items.Add("SOPackageDetail.LineNbr", "SO Package Detail.Line Nbr.");
                    DataField.Items.Add("SOShipLine.InventoryID", "Shipment Line.Inventory ID");
                    DataField.Items.Add("SOShipment.CustomerID", "Shipment.Customer");
                    ...
                    DataField.Items.Add("UploadFile.FileID", "UploadFile.File");
                    DataField.Items.Add("UploadFile.Name", "UploadFile.Name");
                    DataField.Items.Add("UploadFileRevision.Comment", "UploadFileRevision.Comment");
                    DataField.Items.Add("WWOrder.WWDeliveryStatus", "WWOrder.Delivery Status");
                    DataField.Items.Add("WWOrder.WWGPS", "WWOrder.GPS");
                    DataField.Items.Add("WWOrder.WWOrderID", "WWOrder.Order ID");
